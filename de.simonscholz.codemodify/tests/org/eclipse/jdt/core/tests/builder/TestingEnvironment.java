...
//				Indexer.getInstance().waitForIndex(null);
	...
	public void addJavaLibrariesTo(String projectName) throws JavaModelException {
		IJavaProject javaProject = getJavaProject(projectName);
		addJavaLibrariesTo(javaProject);
	}

	public void addJavaLibrariesTo(IPath projectPath) throws JavaModelException {
